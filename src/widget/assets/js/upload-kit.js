        ...
        var methods = {
            ...
            fileuploadInit      : function () {
                ...
                if (options.files) {
                    ...
                    .call($fileupload, $.Event('done'), {result: {files: options.files}});
                    methods.handleEmptyValue();
                    methods.checkInputVisibility();
                }
            },
            ...
            createItem          : function (file) {
                ...
                .append($('<input/>', {
                    "name"       : name + '[' + options.baseImgTitleAttribute + ']',
                    "value"      : file[options.baseImgTitleAttribute],
                    "type"       : "",
                    "placeholder": "image title"
                }))
                .append($('<input/>', {
                    "name"       : name + '[' + options.baseImgAltAttribute + ']',
                    "value"      : file[options.baseImgAltAttribute],
                    "type"       : "",
            ...
            updateOrder         : function () {
                $files.find('.upload-kit-item')
                .each(function (
                    index,
                    item
                ) {
                    $(item)
                    .find('input[data-role=order]')
                    .val(index);
                })
            }
        };
